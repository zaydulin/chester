...
function updateTimer() {
    ...
    var periodeAdd = parseInt(document.getElementById('life-time').getAttribute('data-periode-add')) || 0;
    ...
    var elapsedTime = Math.floor((currentTimestamp - startTimestamp) / 1000) + periodeAdd;
    var periodeTimeElements = document.querySelectorAll('[id="life-time"][data-periode-time]');
    var pauseTimeElements = document.querySelectorAll('[id="life-time"][data-pause-time]');
    periodeTimeElements.forEach(function(element) {
        elapsedTime += parseInt(element.getAttribute('data-periode-time'));
    });
    pauseTimeElements.forEach(function(element) {
