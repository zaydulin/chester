...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    async def receive(self, text_data):
        ...
        data = {"last_incident":new_message.event.slug,"user": new_message.user.username,"avatar":new_message.user.avatar.url, "message": new_message.message,"home_score":new_message.event.home_score,"away_score":new_message.event.away_score}
