    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        upload_to=mainapp.models.get_user_dir,
                        verbose_name="Аватар",
                    ),
                ),
                ...
                (
                    "time_zone",
                    models.PositiveSmallIntegerField(
                        blank=True, choices=[(1, "1"), (2, "2"), (3, "3")], null=True, verbose_name="Часовой пояс"
                    ),
                ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="custom_user_set", to="auth.group", verbose_name="Groups"
                    ),
                ),
                (
                    "user_permissions",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.PositiveSmallIntegerField(
                        blank=True, choices=[(1, "Включить"), (2, "Выключить")], null=True, verbose_name="Тип"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "registration",
                    models.PositiveSmallIntegerField(
                        choices=[(1, "Включено"), (2, "Отключено")], default=1, verbose_name="Регистрация"
                    ),
                ),
                (
                    "of_register_message",
                    models.TextField(
                        blank=True, max_length=500, null=True, verbose_name="Сообщение при отключение регистрации"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "operationsistem",
                    models.CharField(blank=True, max_length=250, null=True, verbose_name="Операционая система"),
                ),
