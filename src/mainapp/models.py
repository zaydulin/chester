...
class GeneralSettings(models.Model):
    ...
    of_register_message = models.TextField("Сообщение при отключение регистрации", max_length=500, blank=True, null=True)
...
class Bookmarks(models.Model):
    user = models.ForeignKey(User, verbose_name='Пользователь', on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
    content_type = models.ForeignKey(ContentType, on_delete=models.CASCADE, verbose_name="Относится", blank=True, null=True)
